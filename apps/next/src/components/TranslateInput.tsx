    ...
    <div className="flex w-full rounded-md shadow-sm">
      <div className="relative flex w-full flex-grow items-stretch focus-within:z-10">
        <input
          ...
          name="answer"
          id="answer"
          className="text-md block w-full rounded-none rounded-l-md border-0 py-3 pl-6 text-black ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-400 sm:text-xl sm:leading-6"
